...
whiptail --title "Arch-Hyprland (2025) Install Script" \
    --msgbox "Welcome to Arch-Hyprland (2025) Install Script!!!\n\n\
...
if pacman -Q hyprland &> /dev/null || pacman -Q hyprland-git &> /dev/null; then
    ...
    printf "${SKY_BLUE}Thank you${RESET} 🫰 for using ${MAGENTA}G00380316 Hyprland Dots${RESET}. ${YELLOW}Enjoy and Have a good day!${RESET}"
    printf "\n%.0s" {1..2}
